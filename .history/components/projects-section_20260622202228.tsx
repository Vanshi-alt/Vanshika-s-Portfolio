...
const projects = [
  ...
  },
  {
    ...
    description:
      "A web application that leverages AI to generate professional resumes based on user input. Users can customize templates, download resumes in PDF format, and share them online. The app uses GROQ <API></API> for content generation and features a responsive design.",
  }
