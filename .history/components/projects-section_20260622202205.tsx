...
import { Github, ExternalLink, Home, ListTodo } from "lucide-react"
...
const projects = [
  ...
  },
  {
    ...
    description:
      "A web application that leverages AI to generate professional resumes based on user input. Users can customize templates, download resumes in PDF format, and share them online. The app uses OpenAI's GPT-3 for content generation and features a responsive design.",
  }
